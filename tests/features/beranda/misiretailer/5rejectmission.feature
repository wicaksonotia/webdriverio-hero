Feature: [HERO] 05. Reject a Mission

  Scenario Outline: As a user, I can reject a mission
    ...
    When I click button Tolak then choose a reason and click button Kirim
    ...
    #Then system should be have status Misi Ditolak
    ...
    Examples:
        ...
        #| Hanifah     | 25          | Misi telah di reject. | Sinkronisasi Data Berhasil |
        | AYAM        | GORENG      | Misi telah di reject. | Sinkronisasi Data Berhasil |
        #| weekend     | 2           | Misi telah di reject. | Sinkronisasi Data Berhasil |